...
<nav class="navbar">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item"><a onclick="openAddCourse(event)" class="nav-link">Renters</a></li>
        <li class="nav-item"><a onclick="openGrade(event)" class="nav-link">Ratings</a></li>
        <li class="nav-item"><a onclick="openEvent(event)" class="nav-link">Events</a></li>
    </ul>
</nav>

<div class="dashboard-container gap-2">
    <img width="394" height="394" src="./profile.jpeg" alt="Student Profile" class="profile-pic ">
